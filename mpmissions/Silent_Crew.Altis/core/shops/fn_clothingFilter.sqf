...
_clothes = switch (life_clothing_store) do
{
	...
	case "bw1": {[_selection] call life_fnc_clothing_bw1;};
	case "bw2": {[_selection] call life_fnc_clothing_bw2;};
	case "bw3": {[_selection] call life_fnc_clothing_bw3;};
	case "bw4": {[_selection] call life_fnc_clothing_bw4;};
};
