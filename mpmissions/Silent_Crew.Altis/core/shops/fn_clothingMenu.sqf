...
if((_this select 3) in ["dive"] && !license_civ_dive) exitWith { hint localize "STR_Shop_NotaDive"; closeDialog 0;};
if((_this select 3) in ["bw1"] && !license_cop_isac1) exitWith { hint localize "STR_Shop_NotaDive"; closeDialog 0;};
if((_this select 3) in ["bw2"] && !license_cop_isac2) exitWith { hint localize "STR_Shop_NotaDive"; closeDialog 0;};
if((_this select 3) in ["bw3"] && !license_cop_isac3) exitWith { hint localize "STR_Shop_NotaDive"; closeDialog 0;};
if((_this select 3) in ["bw4"] && !license_cop_isac4) exitWith { hint localize "STR_Shop_NotaDive"; closeDialog 0;};
