...
_itemInfo = switch (_type) do
{
	...
	case "silver": {["silveru","silver1",250,"Silbererz trennen"]};
	case "silver1": {["silver1","silverp",250,"Feinsilber herstellen"]};
	case "gold": {["goldu","gold1",1600,"Golderz trennen"]};
	case "gold1": {["gold1","gold2",1600,"Gold auflösen"]};
	case "goldp": {["gold2","goldp",1600, "Gold schmelzen"]};
	case "platin": {["plateu","plate1",2100,"Platin verarbeiten"]};
	case "platin1": {["plate1","plate2",2100, "Erz trennen"]};
	case "platin2": {["plate2","platep",2100, "Platin schmelzen"]};
	case "lsd": {["frog","lsd",2100,"LSD kochen"]};//Neu eingefügt
	case "coal": {["coal","coalp",220, "Koks herstellen"]};//neu eingefügt
	case "cigarett": {["tabac","zigarette",190, "Zigaretten herstellen"]};
	case "zigar": {["tabac","zigarren",210, "zigarren herstellen"]};
	case "Kakao": {["cbohne","kakaor",270, "Kakaobohnen rösten"]};
	
	case "kaffee": {["kbohne","kaffeer",310, "Kaffeebohnen rösten"]};
