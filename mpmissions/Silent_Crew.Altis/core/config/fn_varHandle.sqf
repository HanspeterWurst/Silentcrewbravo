...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "bretter": {"life_inv_bretter"};
			case "bauholz": {"life_inv_bauholz"};
			case "baumu": {"life_inv_baumu"};
			case "goldu": {"life_inv_goldu"};
			case "gold1": {"life_inv_gold1"};
			case "gold2": {"life_inv_gold2"};
			case "goldp": {"life_inv_goldp"};
			case "plateu": {"life_inv_plateu"};
			case "plate1": {"life_inv_plate1"};
			case "plate2": {"life_inv_plate2"};
			case "platep": {"life_inv_platep"};
			case "silveru": {"life_inv_silveru"};
			case "silver1": {"life_inv_silver1"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_bretter": {"bretter"};
			case "life_inv_bauholz": {"bauholz"};
			case "life_inv_baumu": {"baumu"};
			case "life_inv_goldu": {"goldu"};
			case "life_inv_coal" : {"coal"};
			case "life_inv_coalp" : {"coalp"};
			case "life_inv_gold1": {"gold1"};
			case "life_inv_gold2": {"gold2"};
			case "life_inv_goldp": {"goldp"};
			case "life_inv_plateu": {"plateu"};
			case "life_inv_plate1": {"plate1"};
			case "life_inv_plate2": {"plate2"};
			case "life_inv_platep": {"platep"};
			case "life_inv_silveru": {"silveru"};
			case "life_inv_silver1": {"silver1"};
