...
switch (_vehicle) do
{
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["textures\offroad_notarzt.paa","med"]
		];
	};
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\suv_cop.jpg","cop"],
			["\a3\soft_f_gamma\SUV_01\Data\suv_01_ext_03_co.paa","civ"],
			["\a3\soft_f_gamma\SUV_01\Data\suv_01_ext_04_co.paa","civ"],
			["textures\suv_adac.paa","adac"],
			["textures\suv_medic.paa","med"]
		];
	};
	...
	case "B_Heli_Light_01_F":
	{
		...
		[
			...
			["textures\Notarzt_Hummingbird.paa","med"]
		];
	};
	...
	case "B_MRAP_01_F":
	{
		_ret = 
		[
			["textures\cop_hunter1.paa","cop"],
			["#(argb,8,8,3)color(0.05,0.05,0.05,1)","fed"],
			["textures\cop_hunter_dea.paa","cop"]
		];
	};
	...
	case "O_Heli_Transport_04_F":
	{
		_ret = 
		[
		["textures\alac_taru_0.paa","adac","textures\alac_taru_1.paa"]
		];
	};	
};
