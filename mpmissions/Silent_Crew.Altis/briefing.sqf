...
// Illegal Items Section
	player createDiaryRecord ["illegalitems",
		[
			"Rebellen Regeln",
				"
				Ein Rebell ist jemand der bewaffneten Wiederstand gegen die Regierung führt. In this case it would be the police. However, due to the small amount of police compared to the possible amount of rebels, do not attack the police without a reason, please be civil and use common sense, and don't take the word rebel literally, but instead how it will make this server fun for all.<br/><br/>
				1. A rebel must first form a gang, and then declare intentions.<br/>
				2. Wiederstand entschuldigt kein RDM (Siehe RDM bei allgemeine Regeln)<br/>
				3. Das Roleplay des Wiederstandes sollte sich in mehr ausdrücken, als in ständigen Banküberfällen und dem erschiessen von Polizisten oder Offiziellen.<br/>
				4. Wiederstand muß organisiert sein.<br/>
				5. Hinter ABSOLUT JEDEM ANGRIFF, muß ein eindeutig nachvollziebarer Grund stehen.<br/><br/>
				"
		]
	];
	player createDiaryRecord ["illegalitems",
		[
			"Gang Regeln",
				"
				1. In einer Gang zu sein ist nicht illegal. Ausser wenn diese in Kriminelle Aktivitäten verstrickt ist.<br/>
				2. In einem Ganggebiet zu sein ist NICHT illegal. Nur bei illegalen Aktivitäten ist es illegal.<br/>
...
// Controls Section
	...
	player createDiaryRecord ["controls",
		[
			"",
				"
				Z: Spieler Menu oeffnen<br/>
				U: Fahrzeuge / Tueren auf / zu schliesen<br/>
				F: Cop/medic Sirene (if cop)<br/>
				T: Fahrzeug Kofferraum<br/>
				Left Shift + R: Festnehmen (Cop Only)<br/>
				Left Shift + G: Niederschlagen (Civ Only, zum ausrauben)<br/>
				Left Windows: Hauptinteraktionstaste. Wird für Interaktion mit anderen Zivilsten oder Fahrzeugen bzw Gegenstaenden benutzt. Oder zum FArmen bzw mining.<br/>
				Left Shift + L: Aktiviert Rundumleuchte (als Cop,Medic oder ADAC).<br/>
